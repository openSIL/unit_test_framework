...
/**
 * @file InitializeResourceManagerDfXTp2Ut.c
 * @brief Unit tests for InitializeResourceManagerDfXTp2Ut
 *
 * Iterations: ["SilPass"]
 *
 */

#include "InitializeResourceManagerDfXTp2Ut.h"
  ...
  )
{
  ...
  if (strcmp(IterationName, "SilPass") == 0) {
    ...
    // Act
    rc = InitializeResourceManagerDfXTp2();
