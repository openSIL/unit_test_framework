...
/**
 * @file InitializeCcxZen4Tp2Ut.c
 * @brief Unit tests for InitializeCcxZen4Tp2Ut
 *
 * Iterations:
 *
 */

#include "InitializeCcxZen4Tp2Ut.h"
  ...
  )
{
  ...
  if (strcmp(IterationName, "TestOne") == 0) {

    // Arrange
    SIL_STATUS rc;

    // Act
    rc = InitializeCcxZen4Tp2();
